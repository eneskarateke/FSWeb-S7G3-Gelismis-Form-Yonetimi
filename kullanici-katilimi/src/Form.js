...
function Data() {
  ...
  const formSchema = Yup.object().shape({
    name: Yup.string().required("Lütfen isminizi girin.").min(3, "En az ÜÇ harf giriniz."),
    email: Yup.string().email("Lütfen geçerli bir email adresi girin.").required("Lütfen email adresinizi girin."),
  ...
  return (<div>
    ...
    {formErrors.termsOfService && <FormFeedback> {formErrors.termsOfService} </FormFeedback>}
